...
export default function FindRooms () {
  const data = [
    ...
    {
      avatar: 'https://pbs.twimg.com/profile_images/1338406029856423943/V0i3Jd4s.jpg',
      host: 'Madhu',
      roomName: 'GooseAppleCar',
      players: '6/12'
    },
    {
      avatar: 'https://pbs.twimg.com/media/EI2tIWZVUAAAWwR.jpg',
      host: 'Arun',
      roomName: 'FoamingMouth',
      players: '8/12'
    },
    {
      avatar: 'https://www.pinkvilla.com/files/styles/contentpreview/public/simbu_m.jpg?itok=IsHNJmy-',
      host: 'Jana',
      roomName: 'LoveBirds',
      players: '7/12'
    },
